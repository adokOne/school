    ...
    e.extend(i.prototype, {
        ...
        _updateDatepicker: function(t) {
            if(!t.dpDiv.children().not('#noRemove').size()){
                t.dpDiv.append($("<div class='group-selector' id='noRemove'><select id='group-selector' name='subsriber[date]' required='required'><option value='' selected='true' disabled='disabled'>Оберіть курс</option></select></div>"))
            }
