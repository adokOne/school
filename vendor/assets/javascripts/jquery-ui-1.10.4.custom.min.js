    ...
    e.extend(i.prototype, {
        ...
        _newInst: function(t, i) {
            ...
            return {
                ...
                drawYear: 0,
                inline: i,
                dpDiv: i ? a(e("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'><div class='group-selector' id='noRemove'><select id='group-selector' name='subsriber[date]' required='required'><option value='' selected='true' disabled='disabled'>Оберіть групу</option></select></div></div>")) : this.dpDiv
            }
        },
        ...
        _updateDatepicker: function(t) {
            if(!t.dpDiv.children().not('#noRemove').size()){
                var text = "Виберіть групу"
                //var text  = $("select#course option:first").text()
                t.dpDiv.append($("<div class='group-selector' id='noRemove'><select id='group-selector' name='subsriber[date]' required='required'><option value='' selected='true' disabled='disabled'>" + text + "</option></select></div>"))
            }
            this.maxRows = 4, n = t, t.dpDiv.children().not('#noRemove').remove(); t.dpDiv.append(this._generateHTML(t)), this._attachHandlers(t), t.dpDiv.find("." + this._dayOverClass + " a").mouseover();
