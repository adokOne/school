...
(function ($) {
  ...
  $.fn.daterange = function (opts) {
    ...
    opts.beforeShow = function (input, inst) {
      ...
      storeLastDateRange([opts.startRangeField.val(),opts.endRangeField.val()], dateFormat);
    ...
    opts.onSelect = function (dateText, inst) {
      var textStart;
      if(lastDateRange && lastDateRange.start && lastDateRange.end){
        lastDateRange = {start: null, end: null};
      }
      if (!inst.rangeStart) {
        inst.inline = true;
       ...
       // if (textStart !== dateText) {
          ...
          opts.startRangeField.val(dateRange.start);
          opts.endRangeField.val(dateRange.end);
